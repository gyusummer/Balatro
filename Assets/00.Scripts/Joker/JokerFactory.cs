...
public class JokerFactory  : Factory<Joker, JokerView>
{
    ...
    protected override void Awake()
    {
        ...
        {
            { 0, () => new EventJoker<CardScoredEventArgs>("Greedy Joker", 5,eventArgs => eventArgs.Card.Suit.HasFlag(CardSuit.Diamond), () => AddMult(3))},
            { 1, () => new EventJoker<CardScoredEventArgs>("Lusty Joker", 5,eventArgs => eventArgs.Card.Suit.HasFlag(CardSuit.Heart), () => AddMult(3))},
            { 2, () => new EventJoker<CardScoredEventArgs>("Wrathful Joker", 5,eventArgs => eventArgs.Card.Suit.HasFlag(CardSuit.Spade), () => AddMult(3))},
            { 3, () => new EventJoker<CardScoredEventArgs>("Gluttonous Joker", 5,eventArgs => eventArgs.Card.Suit.HasFlag(CardSuit.Club), () => AddMult(3))},
